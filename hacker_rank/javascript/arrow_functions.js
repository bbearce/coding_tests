...
// Constraints
// 1 <= n <= 10
// 1 <= nums_i <=100, where nums is the i_th element of nums.
// Output Format
...
// Given nums = [1,2,3,4,5], we modify each element so that all even elements are multiplied by 2 and all odd elements are multipled by 3. In other words, [1,2,3,4,5] => [3,4,9,8,15]. We then return the modified array as our answer.
